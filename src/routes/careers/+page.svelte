...
>
	<div class="absolute inset-0 bg-[url(/images/DWC1.webp)] bg-cover bg-center"></div>
...
<!-- POSITIONS GRID -->
<section class="mx-auto max-w-7xl bg-gray-50 px-6 py-20">
	...
	<div class="grid gap-10 md:grid-cols-2">
		{#each positions as pos}
			...
			>
				...
				<p class="mb-4 text-gray-600">{pos.description}</p>

				<h4 class="font-semibold text-gray-800">Responsibilities:</h4>
				<ul class="mb-4 ml-5 list-disc text-gray-700">
